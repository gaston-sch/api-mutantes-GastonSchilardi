...
class StatsServiceTest {
    ...
    void testGetStatsWithNoHumans() {
        ...
        // Ajusta esto según tu lógica en StatsService.
        // Si tienes división por cero controlada, pon el valor esperado (ej. 0 o el total).
        // Asumiendo que tu lógica retorna 0.0 o el total:
